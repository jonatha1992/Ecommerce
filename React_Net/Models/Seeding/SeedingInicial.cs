...
namespace React_Net.Models.Seeding
{
    public class SeedingInicial
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var CienciaFiccion = new Genero()
            {
                Id = 5,
                Nombre = "Ciencia Ficcion"
            };

            var Animacion = new Genero()
            {
                Id = 6,
                Nombre = "Animacion"
            };

            modelBuilder.Entity<Genero>().HasData(CienciaFiccion, Animacion);
            ...
            var samuelLJacksonSpiderManNWH = new Personaje
            {
            ...
            var samuelLJacksonAvengers = new Personaje
            {
                ActorId = samuelLJackson.Id,
                PeliculaId = avengers.Id,
                Orden = 2,
            ...
            var robertDowneyJuniorAvengers = new Personaje
            {
